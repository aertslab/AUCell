...
To generate an HTML report with your own data and comments, you can use the `.Rmd file` of this tutorial as template (i.e. copy the .Rmd file, and edit it as [R notebook](http://rmarkdown.rstudio.com/r_notebooks.html) in RStudio).
=======
To generate an HTML report with your own data and comments, you can use the `.Rmd file` of this tutorial as template for your own data (i.e. copy the .Rmd file, and edit it as [R notebook](http://rmarkdown.rstudio.com/r_notebooks.html) in RStudio).
...
```{r AUC.plot}
<<<<<<< HEAD
geneSetName <- geneSetNames(cells_AUC)[grep("Oligodendrocyte_Cahoy", geneSetNames(cells_AUC))]
AUC.plot(cells_AUC@AUC[geneSetName,], gSetName=geneSetName)
=======
<<<<<<< HEAD
geneSetName <- geneSetNames(cells_AUC)[grep("Oligodendrocyte_Cahoy", geneSetNames(cells_AUC))]
AUC.plot(cells_AUC@AUC[geneSetName,], gSetName=geneSetName)
...
```{r explThr3}
<<<<<<< HEAD
newSelectedCells <- names(which(cells_AUC@AUC[geneSetName,]>0.08))
=======
<<<<<<< HEAD
newSelectedCells <- names(which(cells_AUC@AUC[geneSetName,]>0.08))
=======
...
<<<<<<< HEAD
  passThreshold <- cells_AUC@AUC[geneSetName,] >  selectedThresholds[geneSetName]
  if(sum(passThreshold) >0 )
  {
     aucSplit <- split(cells_AUC@AUC[geneSetName,], passThreshold)
=======
<<<<<<< HEAD
  passThreshold <- cells_AUC@AUC[geneSetName,] >  selectedThresholds[geneSetName]
  if(sum(passThreshold) >0 )
...
par(mfrow=c(1,2))
<<<<<<< HEAD
geneSetName <- geneSetNames(cells_AUC)[grep("Astrocyte_Cahoy", geneSetNames(cells_AUC))]
=======
<<<<<<< HEAD
geneSetName <- geneSetNames(cells_AUC)[grep("Astrocyte_Cahoy", geneSetNames(cells_AUC))]
cells_assignment[[geneSetName]]$aucThr
AUC.plot(cells_AUC@AUC[geneSetName,])
abline(v=newThreshold)

plot(cellTsne$Y, main=paste(geneSetName, "\n- new assignment"),
       col=c("#90909030","blue")[as.numeric(cells_AUC@AUC[geneSetName,rownames(cellTsne$Y)]>newThreshold)+1],
=======
