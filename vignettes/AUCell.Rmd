...
plot(cellsTsne, main=paste(geneSetName, "\n- new assignment"),
       col=c("#90909030","blue")[as.numeric(getAUC(cells_AUC)[geneSetName,rownames(cellsTsne)]>newThreshold)+1],
       pch=16)
```
...
```{r eval=FALSE}
# Setup 
aucellApp <- AUCell_createViewerApp(auc=cells_AUC, thresholds=selectedThresholds, tSNE=cellsTsne)
